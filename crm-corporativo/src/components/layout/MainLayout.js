...
const MainLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-md transform transition-transform duration-300
      ...
      {/* Main Content */}
      <div className="flex flex-col flex-1 lg:pl-60 lg:pr-60">

        <div className="w-full max-w-7xl">

          {/* Header */}
          <header className="sticky top-0 z-40 h-16 flex items-center justify-between px-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur border-b dark:border-gray-700">
            <div className="flex items-center">
              <button
